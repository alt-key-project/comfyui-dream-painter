...
class BitMapImage:
    ...
    def as_pil_image(self, with_alpha = False, col0: PaintColor = PaintColor("000000"), col1: PaintColor = PaintColor("ffffff")) -> Image:
        mode="RGB"
        if with_alpha:
            mode+="A"
        ...
        print("col1 = "+str([col1.red_hex,col1.green_hex,col1.blue_hex]))
        print("red_range = "+str(red_range))
        print("alpha_range = "+str(alpha_range))
